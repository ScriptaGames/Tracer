...
THREE.TrackballControls = function ( object, domElement ) {
    ...
    var getMouseOnScreen = ( function () {
        ...
        return function getMouseOnScreen( pageX, pageY ) {
            ...
            vector.set(
                _this.X_AXIS_MULT * ( pageX - _this.screen.left ) / _this.screen.width,
                _this.Y_AXIS_MULT * ( pageY - _this.screen.top ) / _this.screen.height
            );
    ...
    var getMouseOnCircle = ( function () {
        ...
        return function getMouseOnCircle( pageX, pageY ) {
            ...
            vector.set(
                _this.X_AXIS_MULT * ( ( pageX - _this.screen.width * 0.5 - _this.screen.left ) / ( _this.screen.width * 0.5 ) ),
                _this.Y_AXIS_MULT * ( ( _this.screen.height + 2 * ( _this.screen.top - pageY ) ) / _this.screen.width ) // screen.width intentional
            );
    ...
    this.rotateCamera = ( function() {
        ...
        return function rotateCamera() {
            ...
            if (_this.follow_controls_on) {
                ...
                _movePrev.set( 0, 0 );
                angle += moveDirection.length() ;// * game.lagScale.get();
            }
            else {
